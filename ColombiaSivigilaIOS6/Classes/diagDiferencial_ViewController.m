//
//  diagDiferencial_ViewController.m
//  VigiaTuSalud
//
...
@interface diagDiferencial_ViewController ()<MFMailComposeViewControllerDelegate>
@property (nonatomic,strong) EventoSalud *eventoSalud;
@end

@implementation diagDiferencial_ViewController
