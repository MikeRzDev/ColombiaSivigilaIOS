//
//  accionesControl_ViewController.m
//  VigiaTuSalud
//
...
@interface accionesControl_ViewController ()<MFMailComposeViewControllerDelegate>
@property (nonatomic,strong) EventoSalud *eventoSalud;
@end

@implementation accionesControl_ViewController
...
-(void) configuracionDelTexto
{
    ...
    NSArray *parrafos = @[
                          ...
                          @"Si la información contenida en este aplicativo no es suficiente para su consulta, por favor tocar sostenido el enlace de abajo para obtener toda la información disponible de este evento.",
                          eventoSalud.linkurl,
                          @"Si necesita información complementaria de parte de la entidad de vigilancia de salud local, por favor utilice el directorio de entidades regionales tocando el botón de abajo."
                          ];
    NSArray *titulos = @[
