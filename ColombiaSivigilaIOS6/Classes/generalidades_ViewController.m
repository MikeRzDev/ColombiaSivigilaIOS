//
//  generalidades_ViewController.m
//  VigiaTuSalud
//
...
@interface generalidades_ViewController () <UITextViewDelegate,MFMailComposeViewControllerDelegate>

@property (nonatomic,strong) EventoSalud *eventoSalud;
@property (nonatomic,assign) Boolean compartir;

@end

@implementation generalidades_ViewController
@synthesize eventoSeleccionado,eventoSalud,textView,tituloEvento,compartir;
